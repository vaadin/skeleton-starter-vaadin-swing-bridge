...
```
java \
  --patch-module java.desktop=./swing-bridge-repo/raw/swing-bridge-patch-1.0.0-alpha7.jar \
  -Xbootclasspath/a:./swing-bridge-repo/com/vaadin/swing-bridge-graphics/1.0.0-alpha7-local/swing-bridge-graphics-1.0.0-alpha7-local.jar \
